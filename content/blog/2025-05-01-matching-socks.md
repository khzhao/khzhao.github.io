...
\begin{align}
E[C] = \frac{1}{\beta(1, n)} \int_0^1 x^\frac{1}{2} (1 - x)^{n-1} dx
&= \frac{\beta(\frac{3}{2}, n)}{\beta(1, n)}
\end{align}
...
$$C = \frac{E[T]}{n + 1} = \frac{\beta(\frac{3}{2}, n)}{\beta(1, n)}$$
$$\implies E[T] = \frac{(n + 1)\beta(\frac{3}{2}, n)}{\beta(1, n)}$$
